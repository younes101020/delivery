            ...
            <form className="space-y-4" onSubmit={saveSettings}>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={event => setSettings(current => ({ ...current, ports: event.target.value }))}
                  placeholder="80, 443"
                />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id={`${id}-environment-variables`}
                  value={settings.environmentVariables}
                  onChange={event => setSettings(current => ({ ...current, environmentVariables: event.target.value }))}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={event => setSettings(current => ({ ...current, startCommand: event.target.value }))}
